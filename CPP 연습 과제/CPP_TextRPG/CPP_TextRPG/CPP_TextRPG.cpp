...
// 구조체 
//struct ObjectInfo { // 총 16바이트 
//	short type; // 2 
//	int hp;	    // 4
//	char attack;// 1
//	int defence;// 4 == 11 바이트? 아님 비트는 정렬됨
//};
...
void CreateRandomMoster() {
	...
	switch (monsterInfo.type){
		case MT_Slime:
			cout << "슬라임 등장!!!! (HP:15 / ATT:5 / DEF:0)" << endl;
			monsterInfo.hp = 15;
			monsterInfo.attack = 5;
			monsterInfo.defence = 0;
			break;
		case MT_Orc:
			cout << "오크 등장!!!! (HP:40 / ATT:10 / DEF:3)" << endl;
			monsterInfo.hp = 40;
			monsterInfo.attack = 10;
			monsterInfo.defence = 3;
			break;
		case MT_Skeleton:
			cout << "스켈레톤 등장!!!! (HP:80 / ATT:15 / DEF:5)" << endl;
			monsterInfo.hp = 80;
